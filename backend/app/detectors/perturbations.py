...
and Perturbation-Aware Training") for scripts/train_siglip2_probe.py.
...
evidence for the general approach (perturb inputs -> extract frozen
features -> train the linear head on the resulting mix), not as
reproducing vincentlc's actual reported robust-AUC numbers -- those were
measured against the specific official pipeline, which this is not.
"""
